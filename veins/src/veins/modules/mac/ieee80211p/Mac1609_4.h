...
protected:
    ...
    double NDL_defTxPowerRelaxed;
    double NDL_defTxPowerActiveVI;
    double NDL_defTxPowerActiveBE;
    double NDL_defTxPowerRelaxedAC_BE;
    double NDL_defTxPowerActiveBK;
    double NDL_defTxPowerRestrictive;
    ...
    ChannelLoadListenerEtsi * listenerETSI;
    ...
    State restrictive;
    State restrictiveAC_VO;
    State restrictiveAC_VI;
    State restrictiveAC_BE;
    State restrictiveAC_BK;
