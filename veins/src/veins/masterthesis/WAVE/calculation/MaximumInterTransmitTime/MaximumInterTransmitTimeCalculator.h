...
private:
    ...
    double calculateSmoothVehicleDensityInRange(double vehicleDensityInRange,
            omnetpp::cOutVector & smoothVehicleDensVec, omnetpp::simtime_t & startTime);

public:
    double calculateMaximumInterTransmission(double vehicleDensityInRange,
