...
const uint64_t BITRATES_80211P[] = { 3000000, 4500000, 6000000, 9000000,
...
enum ChannelNumberEtsi {
    SCH1_ETSI = 172, SCH2_ETSI = 174, SCH3_ETSI = 176, SCH4_ETSI = 178, CCH_ETSI= 180
};
}
